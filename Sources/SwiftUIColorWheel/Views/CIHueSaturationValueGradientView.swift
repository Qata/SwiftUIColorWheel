...
/// This UIViewRepresentable uses `CIHueSaturationValueGradient` to draw a
/// circular gradient with the RGB colour space as a CIFilter.
struct CIHueSaturationValueGradientView: UIViewRepresentable {
    ...
    func makeUIView(context _: Context) -> UIImageView {
        /// Render CIHueSaturationValueGradient and set it to the ImageView that
        /// will be returned.
    ...
    func updateUIView(_ uiView: UIImageView, context _: Context) {
        /// When the view updates eg. brightness changes, a new
        /// CIHueSaturationValueGradient will be generated.
