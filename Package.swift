...
let package = Package(
    ...
    targets: [ // Targets are the basic building blocks of a package. A target
        ...
        .testTarget(
            name: "SwiftUIColorWheelTests",
            dependencies: ["SwiftUIColorWheel"]
        ),
    ]
)
